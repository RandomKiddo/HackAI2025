...
THIS FILE CURRENTLY RUNS THE LATEST DATA LOADING VERSION FOR THE MODEL USING
TENSORFLOW DATASETS. THE FILE USED TO INCLUDE THE OLD DATA LOADING VERSION.
IT OUTPUTS THE TIME TO RUN THE ENTIRE DATA LOADING PROCESS, AND THE MEMORY
BEING USED IN STEPS. THAT DATA CAN BE MANUALLY INPUTTED INTO THE OPTIMIZE
PLOTTER TO SEE THE DIFFERENCES.
"""
